...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 01 Mars 2018 à 18:03
...
INSERT INTO `article` (`idarticle`, `titre`, `introtxt`, `contenutxt`, `contenuimage`, `afficher`, `nbrlecture`, `datecreation`, `idcategorie`, `posteur`) VALUES
...
(77, 'Les jeunes des patlin', 'ces jeunes marocains qui n ont rien dans leur rÃ©gion', '<p>bon, il s&#39;agit l&agrave; d&#39;un petit garcon qui fait des vid&eacute;o sur youtube&nbsp;</p>\r\n\r\n<p>ce qui me fait marrer c&#39;est qu&#39;on lui souffle ce qu&#39;il doit dire dans des &eacute;couteurs et lui il joue bien son r&ocirc;le ses mouvements sont ceux d&#39;un veillard qui a la 60 &egrave;ne&nbsp;</p>\r\n\r\n<hr />\r\n<blockquote>\r\n<p>Si on prenait en compte certianes ville du Maroc on n&#39;aurais pas &agrave; voir ces gens&nbsp;</p>\r\n</blockquote>\r\n', 'images/insolite_moulla7mam.svg', 1, 0, '2018-02-03 22:03:00', 4, ''),
(80, 'Effacer toutes vos données de votre laptop', 'vendre votre ordinateur portable sans qu on restaure vos données', '<p>Le soft : my disk wiper permet supprimer radicalement vos donn&eacute;es . il &nbsp;pourra vous&nbsp;servir si par exemple vous souhaiteriez vendre votre ordinateur portable en effet , si la personne &agrave;&nbsp;qui vous avez vendu votre ordinateur utilise des logiciels de restauration , il pourra facilement r&eacute;er vos document de travail ou photo de vacance Donc my disk wiper va vous permettre d effacer radicalement vos pr&eacute;cieuses donn&eacute;s</p>\r\n', 'images/informatique-restauration.svg', 1, 0, '2018-03-01 00:00:00', 2, 'Wolfcrayser');
...
--
ALTER TABLE `article`
  MODIFY `idarticle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
--
