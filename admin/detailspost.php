          ...
          <div class="card">
            ...
            <div class="card-body">
             ...
             $idarticle=$_GET['idarticle'];
			   ...
			   $sqlarticleedit="select * from article where idarticle=$idarticle";
				$resultarticleedit = mysql_query($sqlarticleedit);
				
				while($data = mysql_fetch_assoc($resultarticleedit)) {
                ...
                <div class=\"form-group\">
                  ...
                  <input type=\"text\" class=\"form-control\" value=".$data["titre"].">
                </div>";
...
-->           
  ...
  <footer id="main-footer" class="bg-dark text-white mt-5 p-5">
    <div class="conatiner">
      <div class="row">
        <div class="col">
          <p class="lead text-center">Copyright &copy; 2018 Mag</p>
        </div>
      </div>
    </div>
  </footer>
